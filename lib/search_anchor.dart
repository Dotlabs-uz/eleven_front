...
// typedef SuggestionsBuilder = FutureOr<Widget> Function(BuildContext context, SearchController controller);
//
...
//     required List<dynamic> listItemInMenu,
...
//
//
//   final List<dynamic> listItemInMenu;
//
...
//   static List<dynamic> listElements = [];
...
//
//   @override
//   void didUpdateWidget(covariant SearchAnchor oldWidget) {
//     if(listElements.length != widget.listItemInMenu) {
//       intialize();
//     }
...
//
//   intialize() {
//     listElements = widget.listItemInMenu;
...
//     super.didUpdateWidget(oldWidget);
//     if (widget.viewRect != oldWidget.viewRect || listElements != widget.listItemInMenu.length ) {
//       _viewRect = widget.viewRect;
//       listElements = widget.listItemInMenu;
//
//     }
...
//     final Widget suggestions = await widget.suggestionsBuilder(context, _controller);
//     if (mounted) {
//       setState(() {
//         result = suggestions;
//       });
...
//
//
//     // print("widget.listItemInMenu.length ${widget.listItemInMenu.length}");
//     // final h = (40  + (widget.listItemInMenu.length * 40 )) > 400? 400 : (50  + (widget.listItemInMenu.length * 40 ));
