...
class TimeTableWithFixedMinutesWidget extends StatefulWidget {
  final List<EmployeeEntity> listEmployee;
  final Function(DateTime from, DateTime to, String employeeId) onTimeConfirm;

  const TimeTableWithFixedMinutesWidget(
      {Key? key, required this.listEmployee, required this.onTimeConfirm})
      : super(key: key);

  @override
  State<TimeTableWithFixedMinutesWidget> createState() => _TimeTableWithFixedMinutesWidgetState();
}

class _TimeTableWithFixedMinutesWidgetState extends State<TimeTableWithFixedMinutesWidget> {
